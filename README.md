...
Set up environment variables by copying the file named .env.example, renaming the copy to .env, and filling in your MySQL database credentials inside the .env file.
